...
public class HorizontalProgressBar extends View {
     ...
     * 进度条颜色
     */
    private int progressColor = 0xFF649aff;
     ...
     */
    private void init() {
        progressPaintWidth = dp2px(2);
        tipHeight = dp2px(15);
        tipWidth = dp2px(30);
        tipPaintWidth = dp2px(1);
        triangleHeight = dp2px(3);
        roundRectRadius = dp2px(5);
        textPaintSize = sp2px(10);
        progressMarginTop = dp2px(0);
     ...
     * @return
     */
    public HorizontalProgressBar setProgressWithAnimationTest() {
    ...
    public HorizontalProgressBar setCurrentProgress(Float progress) {
        ...
        currentProgressWidth = progress/ 100F * (mWidth - paddingLeft - paddingRight);
        textString = progress + "";
        ...
        if (currentProgressWidth >= (tipWidth / 2) &&
                currentProgressWidth <= (mWidth - tipWidth / 2)) {
            moveDis = currentProgressWidth - tipWidth / 2;
        }
    ...
    private void initAnimation() {
        ...
        progressAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                currentProgressWidth = value * (mWidth - getPaddingLeft() - getPaddingLeft()) / 100;
                //进度回调方法

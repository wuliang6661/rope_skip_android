...
public class MyPkFragment_ViewBinding implements Unbinder {
  private MyPkFragment target;

  @UiThread
  public MyPkFragment_ViewBinding(MyPkFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    MyPkFragment target = this.target;
